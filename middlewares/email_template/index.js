exports.verifyOTP = function(otp, currentYear){
			...
			<tbody>
				<tr style="vertical-align: top;" valign="top">
					<td style="word-break: break-word; vertical-align: top;" valign="top">
											...
											<div
												...
												<div
													...
													<div class="txtTinyMce-wrapper"
														...
														<p
															style="margin: 0; font-size: 10px; line-height: 1.2; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; word-break: break-word; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;">
															<strong><span style="font-size: 10px;">Hello,</strong>
														</p>
													</div>
												</div>
												<!--[if mso]></td></tr></table><![endif]-->
												...
												<div
													...
													<div class="txtTinyMce-wrapper"
														...
														<p
															style="margin: 0; font-size: 12px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 18px; margin-top: 0; margin-bottom: 0;">
															<strong><span style="font-size: 10px;">Kindly use the 5 digit OTP below
																	to verify your account.</span></strong>
														</p>
														<p
															style="margin: 0; font-size: 12px; line-height: 1.5; word-break: break-word; mso-line-height-alt: 18px; margin-top: 0; margin-bottom: 0;">
															 </p>
						...
						<div style="background-color:#F4F4F4;">
							<div class="block-grid"
								style="min-width: 120px; max-width: 400px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; Margin: 0 auto; background-color: transparent;">
								<div
									style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
									<!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#F4F4F4;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:700px"><tr class="layout-full-width" style="background-color:transparent"><![endif]-->
											...
											<div
												...
												<div align="center" class="button-container"
													...
													<div
														...
														<span
															style="padding-left:20px;padding-right:20px;font-size:26px;display:inline-block;letter-spacing:undefined;"><span
																style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><span
																	...
																	style="font-size: 10px; line-height: 52px;"><strong>${otp}</strong></span></span></span>
													</div>
